...
variables, function, constraints = read_json('settings.json')

def multi_f(x_vector):
    global variables, function, constraints
    sum_ = func_eval(variables, x_vector, function)
    g = get_evaluated_constraints(variables, x_vector, constraints)
